...
blob_fixups: blob_fixups_user_type = {
    ...
    'vendor/lib64/android.hardware.camera.device-V2-ndk.so': blob_fixup()
        .replace_needed('android.hardware.camera.common-V1-ndk.so', 'android.hardware.camera.common-V2-ndk.so'),
